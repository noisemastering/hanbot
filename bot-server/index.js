...
const convoFlowsRoutes = require('./routes/convoFlowsRoutes');
const flowPromptsRoutes = require('./routes/flowPromptsRoutes');
...
const cannedMessagesRoutes = require('./routes/cannedMessagesRoutes');
...
app.use('/convo-flows', convoFlowsRoutes);
app.use('/flow-prompts', flowPromptsRoutes);
app.use('/ml', mlRoutes);
...
app.use('/canned-messages', cannedMessagesRoutes);
