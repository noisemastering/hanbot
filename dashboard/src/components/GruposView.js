  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-white">Grupos de Productos</h1>
          <p className="text-gray-400 mt-2">Agrupa productos para recomendaciones cruzadas y ofertas complementarias</p>
        </div>
        <button
          onClick={onAdd}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {loading ? (
          ...
          <div className="col-span-full bg-gray-800/50 backdrop-blur-lg border border-gray-700/50 rounded-xl p-12 text-center">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">No hay grupos registrados</h3>
            <p className="text-gray-400 mb-6">Comienza agregando el primer grupo de productos</p>
            <button
              onClick={onAdd}
              ...
              <div className="px-6 py-4">
                ...
                <div className="flex items-center space-x-4 mb-4 text-sm">
                  <div className="flex items-center space-x-2 text-gray-400">
                    ...
                    <span>{grupo.productCount || grupo.products?.length || 0} productos</span>
                  </div>
                  <div className="flex items-center space-x-2 text-gray-400">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                    </svg>
                    <span>Prioridad: {grupo.priority || 5}</span>
                  </div>
                  {grupo.discountPercentage > 0 && (
                    <div className="flex items-center space-x-2 text-green-400">
                      ...
                      <span>{grupo.discountPercentage}% descuento</span>
                    </div>
                  )}
                </div>
                ...
                {grupo.products && grupo.products.length > 0 && (
                  <div className="mb-4">
                    <p className="text-xs text-gray-500 uppercase tracking-wider mb-2">Productos incluidos:</p>
