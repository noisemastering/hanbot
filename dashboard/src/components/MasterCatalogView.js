    ...
    <div>
      ...
      <div className="bg-gray-800/50 backdrop-blur-lg border border-gray-700/50 rounded-xl overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-700/50">
          <h2 className="text-xl font-bold text-white">Entradas del Catálogo Maestro</h2>
        </div>
        ...
        {loading ? (
          ...
          <div className="p-12 text-center">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">No hay entradas en el catálogo</h3>
            <p className="text-gray-400 mb-6">Comienza agregando tu primera entrada al catálogo maestro</p>
            <button
              onClick={onAdd}
            ...
            <table className="w-full">
              ...
              <tbody className="divide-y divide-gray-700/50">
                {subfamilies.map((subfamily) => (
                  <tr key={subfamily._id} className="hover:bg-gray-700/30 transition-colors">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm font-medium text-white">{subfamily.name}</div>
                    </td>
...
export default MasterCatalogView;
