  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center gap-3">
        <button onClick={() => navigate('/crm')} className="text-gray-400 hover:text-white transition-colors" title="Volver">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-800/50 border border-gray-700/50 rounded-xl p-5">
            ...
            <div className="flex flex-wrap gap-2 mb-3">
              ...
              {tags.map(tag => (
                <span key={tag} className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs bg-purple-500/20 text-purple-300">
                  {tag}
                  <button onClick={() => removeTag(tag)} className="hover:text-red-400 transition-colors" title="Eliminar etiqueta">
            ...
            <div className="flex gap-2">
              ...
              />
              <button onClick={addTag} className="px-3 py-1.5 bg-purple-600 hover:bg-purple-700 text-white text-sm rounded-lg transition-colors" title="Agregar etiqueta">+</button>
            </div>
          </div>
              ...
              {notes.slice().reverse().map((note) => (
                <div key={note._id} className="p-3 bg-gray-900/50 rounded-lg">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <button onClick={() => deleteNote(note._id)} className="text-gray-500 hover:text-red-400 transition-colors shrink-0" title="Eliminar nota">
