...
const sections = [
  ...
  },
  {
    ...
    icon: '📈',
    content: [
      { q: '¿Cómo funciona el pronóstico?', a: 'Selecciona un producto (o Global para todo) y un canal de venta. El sistema analiza tu historial de ventas y genera una proyección a 14 días usando regresión lineal ajustada por día de la semana.' },
      { q: '¿Qué es R²?', a: 'Es la medida de qué tan bien el modelo explica tus datos. R² = 0.7+ es bueno, 0.4-0.7 es moderado, <0.4 significa mucha variación que el modelo no captura.' },
      { q: '¿Qué es la estacionalidad?', a: 'Un multiplicador por mes del año basado en tu historial. Meses cálidos (marzo-agosto) suelen tener ventas más altas para malla sombra. Necesitas al menos 6 meses de datos para que sea confiable.' },
      { q: '¿Puedo ajustar el periodo de análisis?', a: 'Sí. Desde 30 días hasta 2 años. Más historia da mejor estacionalidad pero puede incluir patrones obsoletos.' }
    ]
  }
];
