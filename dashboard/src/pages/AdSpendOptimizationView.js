            ...
            <div style={{ minWidth: Math.max(600, ads.filter(a => a.conversions > 0).length * 80) }}>
              <ResponsiveContainer width="100%" height={400}>
                ...
                >
                  ...
                  <XAxis dataKey="name" tick={{ fill: '#9CA3AF', fontSize: 10 }} axisLine={{ stroke: '#374151' }} angle={-35} textAnchor="end" height={90} interval={0} />
                  ...
                  />
                  <Legend wrapperStyle={{ color: '#9CA3AF', bottom: 0 }} verticalAlign="bottom" />
